...
namespace ClinicReportsAPI.Data.Migrations
{
    ...
    [Migration("20230601192717_CambiosParaReportes")]
    partial class CambiosParaReportes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClinicReportsAPI.Data.Entities.MedicalService", b =>
                {
                    ...
                    b.Property<DateTime?>("AuditDateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 6, 1, 14, 27, 17, 563, DateTimeKind.Local).AddTicks(1021));
